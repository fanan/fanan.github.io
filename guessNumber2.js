...
function $s_LDearHenry_App__main__AT__V(args) {
  $m_LDearHenry_GuessNumber2_MainComponent$().run__V()
}
/** @constructor */
function $c_LDearHenry_GuessNumber2_MainComponent$() {
  /*<skip>*/
}
$c_LDearHenry_GuessNumber2_MainComponent$.prototype = new $h_O();
$c_LDearHenry_GuessNumber2_MainComponent$.prototype.constructor = $c_LDearHenry_GuessNumber2_MainComponent$;
/** @constructor */
function $h_LDearHenry_GuessNumber2_MainComponent$() {
  /*<skip>*/
}
$h_LDearHenry_GuessNumber2_MainComponent$.prototype = $c_LDearHenry_GuessNumber2_MainComponent$.prototype;
$c_LDearHenry_GuessNumber2_MainComponent$.prototype.generateRandomNumber__I__I__I = (function(minValue, maxValue) {
  var this$1 = $m_s_util_Random$();
  var n = ((maxValue - minValue) | 0);
  return ((this$1.s_util_Random__f_self.nextInt__I__I(n) + minValue) | 0)
});
$c_LDearHenry_GuessNumber2_MainComponent$.prototype.guess__V = (function() {
  var answer = this.generateRandomNumber__I__I__I(1, 101);
  var body = document.body;
  body.innerHTML = "";
  var logDiv = $m_LDearHenry_ui_package$().newDiv__Lorg_scalajs_dom_HTMLDivElement();
  var inputDiv = $m_LDearHenry_ui_package$().newDiv__Lorg_scalajs_dom_HTMLDivElement();
  body.appendChild(inputDiv);
  body.appendChild(logDiv);
  var label = $m_LDearHenry_ui_package$().newLabel__Lorg_scalajs_dom_HTMLLabelElement();
  label.textContent = "\u8bf7\u8f93\u5165\u4e00\u4e2a\u6574\u6570\uff1a";
  var input = $m_LDearHenry_ui_package$().newInput__Lorg_scalajs_dom_HTMLInputElement();
  var button = $m_LDearHenry_ui_package$().newButton__Lorg_scalajs_dom_HTMLButtonElement();
  inputDiv.appendChild(label);
  inputDiv.appendChild(input);
  inputDiv.appendChild(button);
  var attempt = new $c_sr_IntRef(0);
  button.textContent = "\u6211\u731c\u8fd9\u4e2a\u6570\u662f";
  input.type = "number";
  input.name = "input";
  input.onkeyup = $m_sjs_js_Any$().fromFunction1__F1__sjs_js_Function1(new $c_sjsr_AnonFunction1(((input$1, button$1) => ((x$1$2) => {
    var array = ["\u6211\u731c\u8fd9\u4e2a\u6570\u662f", ""];
    var $$x1 = new $c_s_StringContext(new $c_sjs_js_WrappedArray(array));
    var array$1 = [$as_T(input$1.value)];
    button$1.textContent = $$x1.s__sc_Seq__T(new $c_sjs_js_WrappedArray(array$1))
  }))(input, button)));
  input.onclick = $m_sjs_js_Any$().fromFunction1__F1__sjs_js_Function1(new $c_sjsr_AnonFunction1(((input$1$1) => ((x$2$2) => {
    input$1$1.value = ""
  }))(input)));
  button.onclick = $m_sjs_js_Any$().fromFunction1__F1__sjs_js_Function1(new $c_sjsr_AnonFunction1(((answer$1, logDiv$1, input$1$2, attempt$1) => ((x$3$2) => {
    var rawInput = $uD(input$1$2.valueAsNumber);
    var rawInputAsInt = $doubleToInt(rawInput);
    if (((rawInput - rawInputAsInt) > 0.0)) {
      window.alert("\u8f93\u5165\u7684\u4e0d\u662f\u6574\u6570")
    } else {
      attempt$1.sr_IntRef__f_elem = ((1 + attempt$1.sr_IntRef__f_elem) | 0);
      var p = $m_LDearHenry_ui_package$().newP__Lorg_scalajs_dom_HTMLParagraphElement();
      if ((rawInputAsInt < answer$1)) {
        var array$2 = ["\u7b2c", "\u6b21\u731c\u6d4b\uff1a\u7b54\u6848\u6bd4", "\u5927"];
        var $$x2 = new $c_s_StringContext(new $c_sjs_js_WrappedArray(array$2));
        var array$3 = [attempt$1.sr_IntRef__f_elem, rawInputAsInt];
        p.textContent = $$x2.s__sc_Seq__T(new $c_sjs_js_WrappedArray(array$3))
      } else if ((rawInputAsInt > answer$1)) {
        var array$4 = ["\u7b2c", "\u6b21\u731c\u6d4b\uff1a\u7b54\u6848\u6bd4", "\u5c0f"];
        var $$x3 = new $c_s_StringContext(new $c_sjs_js_WrappedArray(array$4));
        var array$5 = [attempt$1.sr_IntRef__f_elem, rawInputAsInt];
        p.textContent = $$x3.s__sc_Seq__T(new $c_sjs_js_WrappedArray(array$5))
      } else {
        var array$6 = ["\u7b2c", "\u6b21\u731c\u6d4b\uff1a\u7b54\u6848\u5c31\u662f", ""];
        var $$x4 = new $c_s_StringContext(new $c_sjs_js_WrappedArray(array$6));
        var array$7 = [attempt$1.sr_IntRef__f_elem, rawInputAsInt];
        p.textContent = $$x4.s__sc_Seq__T(new $c_sjs_js_WrappedArray(array$7))
      };
      logDiv$1.prepend(p);
      if ((rawInputAsInt === answer$1)) {
        var $$x6 = window;
        var array$8 = ["\u7b2c", "\u6b21\u5c31\u731c\u5bf9\u4e86\uff0cHenry\u592a\u5389\u5bb3\u4e86\u5427"];
        var $$x5 = new $c_s_StringContext(new $c_sjs_js_WrappedArray(array$8));
        var array$9 = [attempt$1.sr_IntRef__f_elem];
        $$x6.alert($$x5.s__sc_Seq__T(new $c_sjs_js_WrappedArray(array$9)));
        $m_LDearHenry_GuessNumber2_MainComponent$().guess__V()
      }
    }
  }))(answer, logDiv, input, attempt)))
});
$c_LDearHenry_GuessNumber2_MainComponent$.prototype.run__V = (function() {
  document.body.classList.add("is-centered");
  this.guess__V()
});
var $d_LDearHenry_GuessNumber2_MainComponent$ = new $TypeData().initClass({
  LDearHenry_GuessNumber2_MainComponent$: 0
}, false, "DearHenry.GuessNumber2.MainComponent$", {
  LDearHenry_GuessNumber2_MainComponent$: 1,
  O: 1
});
$c_LDearHenry_GuessNumber2_MainComponent$.prototype.$classData = $d_LDearHenry_GuessNumber2_MainComponent$;
var $n_LDearHenry_GuessNumber2_MainComponent$;
function $m_LDearHenry_GuessNumber2_MainComponent$() {
  if ((!$n_LDearHenry_GuessNumber2_MainComponent$)) {
    $n_LDearHenry_GuessNumber2_MainComponent$ = new $c_LDearHenry_GuessNumber2_MainComponent$()
  };
  return $n_LDearHenry_GuessNumber2_MainComponent$
}
/** @constructor */
function $c_LDearHenry_ui_package$() {
  /*<skip>*/
}
$c_LDearHenry_ui_package$.prototype = new $h_O();
$c_LDearHenry_ui_package$.prototype.constructor = $c_LDearHenry_ui_package$;
/** @constructor */
function $h_LDearHenry_ui_package$() {
  /*<skip>*/
}
$h_LDearHenry_ui_package$.prototype = $c_LDearHenry_ui_package$.prototype;
$c_LDearHenry_ui_package$.prototype.newButton__Lorg_scalajs_dom_HTMLButtonElement = (function() {
  return document.createElement("button")
});
$c_LDearHenry_ui_package$.prototype.newDiv__Lorg_scalajs_dom_HTMLDivElement = (function() {
  return document.createElement("div")
});
$c_LDearHenry_ui_package$.prototype.newP__Lorg_scalajs_dom_HTMLParagraphElement = (function() {
  return document.createElement("p")
});
$c_LDearHenry_ui_package$.prototype.newInput__Lorg_scalajs_dom_HTMLInputElement = (function() {
  return document.createElement("input")
});
$c_LDearHenry_ui_package$.prototype.newLabel__Lorg_scalajs_dom_HTMLLabelElement = (function() {
  return document.createElement("label")
});
var $d_LDearHenry_ui_package$ = new $TypeData().initClass({
  LDearHenry_ui_package$: 0
}, false, "DearHenry.ui.package$", {
  LDearHenry_ui_package$: 1,
  O: 1
});
$c_LDearHenry_ui_package$.prototype.$classData = $d_LDearHenry_ui_package$;
var $n_LDearHenry_ui_package$;
function $m_LDearHenry_ui_package$() {
  if ((!$n_LDearHenry_ui_package$)) {
    $n_LDearHenry_ui_package$ = new $c_LDearHenry_ui_package$()
  };
  return $n_LDearHenry_ui_package$
}
/** @constructor */
...
$c_sc_LinearSeqLike$$anon$1.prototype.next__O = (function() {
  if (this.hasNext__Z()) {
    var this$1 = this.sc_LinearSeqLike$$anon$1__f_these;
    this$1.head__E()
  } else {
...
class $c_s_StringContext$InvalidEscapeException extends $c_jl_IllegalArgumentException {
  constructor(str, index) {
    ...
    var $$x3 = new $c_s_StringContext(new $c_sjs_js_WrappedArray(array));
    $m_s_Predef$().require__Z__V(((index >= 0) && (index < $uI(str.length))));
    if ((index === (((-1) + $uI(str.length)) | 0))) {
      var $$x1 = "at terminal"
    } else {
      var array$1 = ["'\\\\", "' not one of ", " at"];
      var $$x2 = new $c_s_StringContext(new $c_sjs_js_WrappedArray(array$1));
      var index$1 = ((1 + index) | 0);
      var array$2 = [$bC((65535 & $uI(str.charCodeAt(index$1)))), "[\\b, \\t, \\n, \\f, \\r, \\\\, \\\", \\']"];
      var $$x1 = $$x2.s__sc_Seq__T(new $c_sjs_js_WrappedArray(array$2))
    };
    var array$3 = [$$x1, index, str];
    var s = $$x3.s__sc_Seq__T(new $c_sjs_js_WrappedArray(array$3));
    $ct_jl_Throwable__T__jl_Throwable__Z__Z__(this, s, null, true, true)
  };
}
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
$s_LDearHenry_App__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
